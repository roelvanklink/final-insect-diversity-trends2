...
load("completeData2022pure.RData") ; dim(completeData2022pure)
completeData2022max10plots<- readRDS(file = "completeData2022max10plots.rds")  ; dim(completeData2022max10plots)
completeData2022max20plots<- readRDS(file = "completeData2022max20plots.rds")  ; dim(completeData2022max20plots)
completeData2022max50plots<- readRDS(file = "completeData2022max50plots.rds")  ; dim(completeData2022max50plots)
completeData2022short<- readRDS(file = "completeData2022short.rds");dim(completeData2022short)
completeData2022long<- readRDS(file = "completeData2022long.rds") ; dim(completeData2022long)




# exclude experimental plots and datasets
...
completeData2022pure<- completeData2022pure[!completeData2022pure$Plot_ID %in% exptPlots, ]; dim(completeData2022pure)
completeData2022pure<- completeData2022pure[!completeData2022pure$Plot_ID %in% bad_tax, ]; dim(completeData2022pure)

completeData2022max50plots<- completeData2022max50plots[!completeData2022max50plots$Plot_ID %in% exptPlots, ]; dim(completeData2022max50plots)
completeData2022max50plots<- completeData2022max50plots[!completeData2022max50plots$Datasource_ID %in% exptDatasources, ]; dim(completeData2022max50plots)
completeData2022max50plots<- completeData2022max50plots[!completeData2022max50plots$Datasource_ID %in% bad_tax, ]; dim(completeData2022max50plots)

completeData2022max20plots<- completeData2022max20plots[!completeData2022max20plots$Plot_ID %in% exptPlots, ]; dim(completeData2022max20plots)
completeData2022max20plots<- completeData2022max20plots[!completeData2022max20plots$Datasource_ID %in% exptDatasources, ]; dim(completeData2022max20plots)
completeData2022max20plots<- completeData2022max20plots[!completeData2022max20plots$Datasource_ID %in% bad_tax, ]; dim(completeData2022max20plots)

completeData2022max10plots<- completeData2022max10plots[!completeData2022max10plots$Plot_ID %in% exptPlots, ]; dim(completeData2022max10plots)
completeData2022max10plots<- completeData2022max10plots[!completeData2022max10plots$Datasource_ID %in% exptDatasources, ]; dim(completeData2022max10plots)
completeData2022max10plots<- completeData2022max10plots[!completeData2022max10plots$Datasource_ID %in% bad_tax, ]; dim(completeData2022max10plots)

completeData2022short<- completeData2022short[!completeData2022short$Plot_ID %in% exptPlots, ]; dim(completeData2022short)
completeData2022short<- completeData2022short[!completeData2022short$Datasource_ID %in% exptDatasources, ]; dim(completeData2022short)
completeData2022short<- completeData2022short[!completeData2022short$Datasource_ID %in% bad_tax, ]; dim(completeData2022short)

completeData2022long<- completeData2022long[!completeData2022long$Plot_ID %in% exptPlots, ]; dim(completeData2022long)
completeData2022long<- completeData2022long[!completeData2022long$Datasource_ID %in% exptDatasources, ]; dim(completeData2022long)
completeData2022long<- completeData2022long[!completeData2022long$Datasource_ID %in% bad_tax, ]; dim(completeData2022long)
...
completeData2022max50plotsRichness <- subset(completeData2022max50plots, Unit == "richness"); dim(completeData2022max50plotsRichness)
completeData2022max20plotsRichness <- subset(completeData2022max20plots, Unit == "richness"); dim(completeData2022max20plotsRichness)
completeData2022max10plotsRichness <- subset(completeData2022max10plots, Unit == "richness"); dim(completeData2022max10plotsRichness)
completeData2022max50plotsAbundance <- subset(completeData2022max50plots, Unit == "abundance"); dim(completeData2022max50plotsAbundance)
completeData2022max20plotsAbundance <- subset(completeData2022max20plots, Unit == "abundance"); dim(completeData2022max20plotsAbundance)
completeData2022max10plotsAbundance <- subset(completeData2022max10plots, Unit == "abundance"); dim(completeData2022max10plotsAbundance)
completeData2022max50plotsENSPIE <-    subset(completeData2022max50plots, Unit == "ENSPIE"); dim(completeData2022max50plotsENSPIE)
completeData2022max50plotsENSPIE$Number[completeData2022max50plotsENSPIE$Number == Inf] <- NA
completeData2022max20plotsENSPIE <-    subset(completeData2022max20plots, Unit == "ENSPIE"); dim(completeData2022max20plotsENSPIE)
completeData2022max20plotsENSPIE$Number[completeData2022max20plotsENSPIE$Number == Inf] <- NA
completeData2022max10plotsENSPIE <-    subset(completeData2022max10plots, Unit == "ENSPIE"); dim(completeData2022max10plotsENSPIE)
completeData2022max10plotsENSPIE <-  completeData2022max10plotsENSPIE[!is.infinite(completeData2022max10plotsENSPIE$Number),] ; dim(completeData2022max10plotsENSPIE)
completeData2022max10plotsENSPIE$Number[completeData2022max10plotsENSPIE$Number == Inf] <- NA
completeData2022shortRichness <-  	 subset(completeData2022short, Unit == "richness"); dim(completeData2022shortRichness)
completeData2022shortAbundance <- 	 subset(completeData2022short, Unit == "abundance"); dim(completeData2022shortAbundance)
completeData2022shortENSPIE <- 		subset(completeData2022short, Unit == "ENSPIE"); dim(completeData2022shortENSPIE)
completeData2022shortENSPIE$Number[completeData2022shortENSPIE$Number == Inf] <- NA; dim(completeData2022shortENSPIE)
completeData2022longRichness <- 	subset(completeData2022long, Unit == "richness"); dim(completeData2022longRichness)
completeData2022longAbundance <-  subset(completeData2022long, Unit == "abundance"); dim(completeData2022longAbundance)
completeData2022longENSPIE <- 		subset(completeData2022long, Unit == "ENSPIE"); dim(completeData2022longENSPIE)
completeData2022longENSPIE$Number[completeData2022longENSPIE$Number == Inf] <- NA


cDhorn     <- subset( completeData2022, Unit == "HornLast"); dim(cDhorn)
...
cDbray     <- subset(completeData2022, Unit == "BrayLast"); dim(cDbray)
...
cDjaccard  <- subset(completeData2022, Unit == "JaccardLast") ; dim(cDjaccard)
...
all.df<-list(completeData2022max50plotsRichness = completeData2022max50plotsRichness,
						 completeData2022max20plotsRichness = completeData2022max20plotsRichness, 
						 completeData2022max10plotsRichness = completeData2022max10plotsRichness,
						 completeData2022max50plotsAbundance =completeData2022max50plotsAbundance,
						 completeData2022max20plotsAbundance =completeData2022max20plotsAbundance,
						 completeData2022max10plotsAbundance = completeData2022max10plotsAbundance,
						 completeData2022max50plotsENSPIE =completeData2022max50plotsENSPIE,
						 completeData2022max20plotsENSPIE =completeData2022max20plotsENSPIE,
						 completeData2022max10plotsENSPIE =completeData2022max10plotsENSPIE,
						 completeData2022shortRichness =completeData2022shortRichness,
						 completeData2022shortAbundance =completeData2022shortAbundance,
						 completeData2022shortENSPIE =completeData2022shortENSPIE,
						 completeData2022longRichness =completeData2022longRichness,
						 completeData2022longAbundance =completeData2022longAbundance,
						 completeData2022longENSPIE =completeData2022longENSPIE,
						 cDjaccard =cDjaccard,
						 cDhorn =cDhorn,
						 cDbray = cDbray
						 )
