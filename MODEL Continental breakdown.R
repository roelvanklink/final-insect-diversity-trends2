...
#exclude experinmental plots and datasets
...
# unique ID for year/plot combination so that we exclude some years 
...
completeData2022$Continent_4INLA <- as.numeric(factor(completeData2022$Continent))
completeData2022$Continent_4INLAs <- completeData2022$Continent_4INLA + max(completeData2022$Continent_4INLA)
